...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Drawer Obj Repo/Private Channel Label'), 5, FailureHandling.CONTINUE_ON_FAILURE)){
	System.out.println('Success find Private Chanel Label');
}
else {
	System.out.println('Cant not find Private Chanel Label');
}
WebUI.closeBrowser()