...
WebUI.click(findTestObject('Object Repository/Drawer Obj Repo/Create Direct Message Button'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Popup Direct Message/Label Title'), 0)
WebUI.closeBrowser()