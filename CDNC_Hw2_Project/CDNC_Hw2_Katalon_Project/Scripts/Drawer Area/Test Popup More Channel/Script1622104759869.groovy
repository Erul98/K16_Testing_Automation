...
WebUI.click(findTestObject('Object Repository/Drawer Obj Repo/More Button'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Popup More Channel/Label'),0)
WebUI.closeBrowser()