...
WebUI.click(findTestObject('Object Repository/Popup New Chanel/Edit URL Button'))
WebUI.click(findTestObject('Object Repository/Popup New Chanel/Change Channel URL Button'))
WebUI.verifyElementPresent(findTestObject('Object Repository/Popup New Chanel/Input Error'), 0)
WebUI.closeBrowser()