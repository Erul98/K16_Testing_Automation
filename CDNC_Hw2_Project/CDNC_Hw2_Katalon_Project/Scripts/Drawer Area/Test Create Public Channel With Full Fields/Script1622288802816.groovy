...
for (def index : (0..data.getRowNumbers() - 1)) {
	...
	WebUI.setText(findTestObject('Object Repository/Popup New Chanel/Purpose TextArea'), data.internallyGetValue("purpose", index))
	WebUI.setText(findTestObject('Object Repository/Popup New Chanel/Header TextArea'), data.internallyGetValue("header", index))
